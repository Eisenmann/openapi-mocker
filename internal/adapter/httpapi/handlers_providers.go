...
func (a *api) listProvidersGlobal(w http.ResponseWriter, r *http.Request) {
...
func (a *api) updateProvider(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.s.Providers.Update(&p); err != nil {
...
func (a *api) deleteProvider(w http.ResponseWriter, r *http.Request) {
	if err := a.s.Providers.Delete(r.PathValue("providerId")); err != nil {
		writeError(w, http.StatusNotFound, err)
		return
	}
...
func (a *api) testProvider(w http.ResponseWriter, r *http.Request) {
	if err := a.s.Providers.Test(r.Context(), r.PathValue("providerId")); err != nil {
